...
while True:
    {
        ...
        display.show()
        display.fill(1)
        display.text("this is testing the refresh!", 0, 0, 0)
        display.text("REFRESH", 0, 8, 0)
        display.text("REFRESH", 0, 16, 0)
        display.text("REFRESH", 0, 24, 0)
        display.text("REFRESH", 0, 32, 0)
        display.text("REFRESH", 0, 40, 0)
        display.show()
    }
